    ...
    return (
        <div className="container mt-3 padre">
            <Link to="/Aurora" className="links">
                <figure>
                    <img src={Aurora3} alt="" className="tamaño-immg"></img>
                    <figcaption>Aurora</figcaption>
                </figure>            
            </Link>    
            <Link to="/Beach" className="links">
                <figure>
                    <img src={Beach3} alt="" className="tamaño-immg"></img>
                    <figcaption>Beach</figcaption>
                </figure>            
            </Link>  
            <Link to="/Forest" className="links">
                <figure>
                    <img src={Forest3} alt="" className="tamaño-immg"></img>
                    <figcaption>Forest</figcaption>
                </figure>            
            </Link>  
            <Link to="/Jungle" className="links">
                <figure>
                    <img src={Jungle3} alt="" className="tamaño-immg"></img>
                    <figcaption>Jungle</figcaption>
                </figure>            
            </Link>  
            <Link to="/Lake" className="links">
                <figure>
                    <img src={Lake3} alt="" className="tamaño-immg"></img>
                    <figcaption>Lake</figcaption>
                </figure>            
            </Link>  
            <Link to="/Milky" className="links">
                <figure>
                    <img src={Milky3} alt="" className="tamaño-immg"></img>
